...
const Footer = ({ className = "" }: FooterProps) => {
  return (
    <footer className={`bg-gray-900 text-white pt-36 pb-24 mt-24 ${className}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="space-y-8">
            ...
            <p className="font-serif text-lg text-gray-300 leading-relaxed">
              Creating meaningful design experiences through thoughtful craftsmanship and artistic vision.
            </p>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <Link href="#work" className="block font-serif text-lg text-gray-300 hover:text-white transition-colors duration-300">
                Work
              </Link>
              <Link href="#about" className="block font-serif text-lg text-gray-300 hover:text-white transition-colors duration-300">
                About
              </Link>
          ...
          {/* Connect Column */}
          <div className="space-y-8">
            <h3 className="font-serif text-2xl mb-6 border-b border-gray-700 pb-4">Connect</h3>
            <div className="space-y-6">
              <a
